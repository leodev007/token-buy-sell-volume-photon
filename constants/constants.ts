...
export const TP_LEVEL = Number(retrieveEnvVariable('TP_LEVEL', logger));
export const SL_LEVEL = Number(retrieveEnvVariable('SL_LEVEL', logger));
export const SELL_TIMER = Number(retrieveEnvVariable('SELL_TIMER', logger));
